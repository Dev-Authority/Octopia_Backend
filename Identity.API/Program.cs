...
var mongoIdentityConfiguration = new MongoDbIdentityConfiguration
{
    ...
    {
        ConnectionString = "mongodb+srv://mehdiakkaemail:eSMsbDE5FIdQXeHh@octopia.adzeywo.mongodb.net/test",
        DatabaseName = "Octopia"
    },
...
builder.Services.ConfigureMongoDbIdentity<User, Role, Guid>(mongoIdentityConfiguration)
